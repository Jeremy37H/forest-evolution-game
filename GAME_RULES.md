...
* **升級消耗與限制**：
  ...
  * **規則限制**：
    1. **每回合最多只能升級一次**。
    2. **不限初始血量**，只要剩餘血量足以支付升級消耗即可（若扣至 0 HP 則會淘汰）。
* **等級素質**：
  * Lv1: 攻擊 2 / 防禦 0
  * Lv2: 攻擊 4 / 防禦 2
  * Lv3: 攻擊 5 / 防禦 4
...
* **寄生** [主動/一次性/討論階段]：指定一位玩家，將自己的血量變更為與對方相同（有上下限限制）。
* **腎上腺素** [被動]：當自身 HP 低於 10 時，攻擊力額外 +3。
* **同病相憐** [主動/討論階段]：將自己本回合受到的傷害同步連結給目標。

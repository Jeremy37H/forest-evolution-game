...
### 第二回合技能
*   **兩棲** [被動]：可以攻擊除了自己屬性以外的所有屬性 (同屬性反而會輸)。
*   **寄生** [主動/一次性/討論階段]：指定一位玩家，將自己的血量變更為對方的血量。
*   **森林權杖** [主動/一次性/討論階段]：指定一個屬性，該屬性 Lv1 以上的所有玩家扣除 2 點 HP。
*   **適者生存** [被動]：升級時，攻擊與防禦點數各額外 +1。
*   **龜甲** [被動]：獲得此技能時，防禦力永久 +3。

### 第三回合技能
*   **獅子王** [主動/討論階段]：每回合可指定一位玩家當手下。攻擊時，對方需承受自己與手下的雙重攻擊。
*   **瞪人** [主動/討論階段]：指定兩位玩家，被指定者該回合無法攻擊你。
*   **斷尾** [被動]：被攻擊時，自己扣 2 點 HP，並躲過對方攻擊（不受戰鬥傷害）。
*   **冬眠** [主動/討論階段]：該回合進入冬眠，無法攻擊也無法被攻擊 (無敵狀態)。
*   **禿鷹** [被動]：當場上有玩家死亡時，自己恢復 3 點 HP。

## 勝利條件
*   戰鬥至最後一人存活。
*   或遊戲強制結束時，剩餘血量 (HP) 最高者獲勝。
